...
export default function register() {
   ...
   //     <h2 class="text-3xl font-semibold text-center text-gray-700 capitalize"> Register</h2>
   ...
   //             <button class="px-6 py-2 leading-5 text-white transition-colors duration-200 transform bg-gray-700 rounded-md hover:bg-gray-600 focus:outline-none focus:bg-gray-600">Sign Up</button>
   //         </div>
   //     </form>
   // </section> */}
        </div>
